...
function main()
	...
	if not _handlersLoaded then
		...
		while true do
			wait(0)
			local responded, button =
				sampHasDialogRespond(_MISSING_LIB_DIALOG_ID)
			if responded then
				if button == 1 then
