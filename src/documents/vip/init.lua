...
local DEFAULTS = {
	...
	premiumLevels = {
		[1] = {
			...
			mark = true,
			text = {
				value = u8"Телепорт транспорта и отсутствие налогов на тс.",
				enabled = true,
			},
			desc = {
				value = u8"Возможность телепортировать к себе личный транспорт",
				enabled = true,
			},
		},
		[2] = {
			...
			mark = true,
			text = {
				value = u8"Отсутствие поломок аксессуаров",
				enabled = true,
			},
			desc = {
				value = u8"При смерти аксессуары не будут терять прочности",
				enabled = true,
			},
		},
		[3] = {
			...
			mark = false,
			text = {
				value = u8"Мидас, быстрый призыв охранника",
				enabled = true,
			},
			desc = {
				value = u8"Время на призыв охранника 3 секунды",
				enabled = true,
			},
		},
		[4] = {
			...
			mark = true,
			text = {
				value = u8"2 точки спавна",
				enabled = true,
			},
			desc = {
				value = u8"Возможность устанавливать до 2-х точек для спавна",
				enabled = true,
			},
		},
		[5] = {
			...
			mark = true,
			text = {
				value = u8"Доп. слоты имущества",
				enabled = true,
			},
			desc = {
				value = u8"+3 слота для домов, +10 для транспорта",
				enabled = true,
			},
		},
		[6] = {
			...
			mark = true,
			text = {
				value = u8"+1 страница инвентаря",
				enabled = true,
			},
			desc = {
				value = u8"Увеличенный стак ресурсов",
				enabled = true,
			},
		},
		[7] = {
			...
			mark = false,
			text = {
				value = u8"Porsche 992 Off-Road",
				enabled = true,
			},
			desc = {
				value = u8"Медленная потеря сытости",
				enabled = true,
			},
		},
		[8] = {
			...
			mark = false,
			text = {
				value = u8"Увеличенный шанс крафта",
				enabled = true,
			},
			desc = {
				value = u8"+1% к успешному крафту",
				enabled = true,
			},
		},
		[9] = {
			...
			mark = false,
			text = {
				value = u8"Увеличенный дроп",
				enabled = true,
			},
			desc = {
				value = u8"+15% дроп с ларцов и контейнеров",
				enabled = true,
			},
		},
		[10] = {
			...
			mark = false,
			text = {
				value = u8"Паспорт Vice City",
				enabled = true,
			},
			desc = {
				value = u8"Сборка шаров в зеленой зоне",
				enabled = true,
			},
		},
	},
