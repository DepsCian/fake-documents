...
local FIELD_MAP = {
    ...
    { stateKey = "army_online",      jsonKey = "army_online" },
    { stateKey = "have_army_ticket", jsonKey = "have_army_ticket" },
...
function Builder.build()
    ...
    local json = '{"type":8,"not":false' .. JsonBuilder.buildFields(s, FIELD_MAP) .. '}'
